...
import screeninfo
from PyQt6.QtWidgets import QWidget, QVBoxLayout, QLabel, QMainWindow, QPushButton, QApplication, QProgressBar
...
class VolumeBar(QWidget):
    ...
    def _get_monitor_center(self, bar_width, bar_height) -> QRect:
        ...
        return QRect(round(monitor.x + monitor.width / 2 - bar_width / 2), round(monitor.y + monitor.height / 2 - bar_height / 2), bar_width, bar_height)
